...
def create_heatmap_plot(json_file_path, output_png_path, sigma=15):
    ...
    # Use 'hot_r' colormap: white for low values (fast times), progressing through red to black for high values (slow times).
    ...
    plt.imshow(smoothed_heatmap, cmap='hot_r', origin='upper', vmin=0, vmax=max_val, interpolation='bilinear')
